/*
 * xnat-data-models: org.nrg.xdat.om.base.BaseXnatDicomseriesImage
...
public class BaseXnatDicomseriesImage extends AutoXnatDicomseriesImage {
    ...
    public void moveTo(File newSessionDir, String existingSessionDir, String rootPath,
					   @Nullable String currentProject, @Nullable String destinationProject,
					   UserI user, EventMetaI ci)  throws IOException, Exception {
