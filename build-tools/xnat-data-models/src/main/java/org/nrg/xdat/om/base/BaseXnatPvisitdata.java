/*
 * xnat-data-models: org.nrg.xdat.om.base.BaseXnatPvisitdata
...
public class BaseXnatPvisitdata extends AutoXnatPvisitdata implements Comparable {
    ...
    public static synchronized String CreateNewID() throws Exception{
		return IDGeneratorFactory.getInstance().getIDGenerator("xnat_pvisitData").generateIdentifier();
    }
	                ...
	                while (table.hasMoreRows())
	                {
	                    ...
	                    try {
	                        ...
	                        //grab the experiment, clear out visit and save...
	   	                    ...
	   	                    if(StringUtils.equalsIgnoreCase(frank.getVisit(), visitId)){
