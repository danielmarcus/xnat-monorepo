/*
 * dicom-xnat-mx: org.nrg.sl4fj.PrintWriterLogger
 ...
 * for all defined loggers, to the provided PrintWriter. This is a trivial adaptation
 * of the slf4j SimpleLogger (which writes all output to System.err).
 * The following system properties are supported to configure the behavior of this logger:</p>
 * <ul>
 * <li><code>org.nrg.slf4j.printwriterlogger.defaultlog</code> -
 *     Default logging detail level for all instances of SimpleLogger.
 *     Must be one of ("trace", "debug", "info", "warn", or "error").
 *     If not specified, defaults to "info". </li>
 * <li><code>org.nrg.slf4j.printwriterlogger.log.xxxxx</code> -
 *     Logging detail level for a SimpleLogger instance named "xxxxx".
 *     Must be one of ("trace", "debug", "info", "warn", or "error").
 *     If not specified, the default logging detail level is used.</li>
 * <li><code>org.nrg.slf4j.printwriterlogger.showdatetime</code> -
 ...
 * <li><code>org.nrg.slf4j.printwriterlogger.dateTimeFormat</code> -
 ...
 * <li><code>org.nrg.slf4j.printwriterlogger.showthreadname</code> -
 *     Set to <code>true</code> if you want to output the current thread name.
 *     Defaults to <code>true</code>.</li>
 * <li><code>org.nrg.slf4j.printwriterlogger.showlogname</code> -
 *     Set to <code>true</code> if you want the Logger instance name to be
 *     included in output messages. Defaults to <code>true</code>.</li>
 * <li><code>org.nrg.slf4j.printwriterlogger.showShortLogname</code> -
 ...
 *
 *
 * <p>With no configuration, the default output includes the relative time in milliseconds,
 ...
 */
public class PrintWriterLogger extends MarkerIgnoringBase implements MicroLog,Closeable {
    private static final long serialVersionUID = -2450461596883086074L;
...
/**
  ...
  private static final String CONFIGURATION_FILE = "printwriterlogger.properties";

  /** All system properties used by <code>SimpleLogger</code> start with this */
  private static final String systemPrefix = "org.nrg.slf4j.printwriterlogger.";
  ...
  private static boolean showMillis = false;
...
//  public static final int LOG_LEVEL_FATAL  = 6;
  ...
  public PrintWriterLogger(String name, final PrintWriter writer) {
    this.name = name;
    this.writer = writer;
  ...
  public PrintWriterLogger(final File outfile) throws FileNotFoundException {
      this(outfile.getPath(), new PrintWriter(outfile));
  }
