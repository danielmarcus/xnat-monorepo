/*
 * xnat-data-models: org.nrg.xdat.om.base.BaseXnatResourceseries
...
public class BaseXnatResourceseries extends AutoXnatResourceseries {
    ...
    public void moveTo(File newSessionDir, String existingSessionDir, String rootPath, @Nullable String currentProject,
                       @Nullable String destinationProject, UserI user, final EventMetaI ci)
    	...
    	for(File f: this.getCorrespondingFiles(rootPath)){
    		FileUtils.MoveFile(f, new File(newFile,f.getName()), true, true,new FileHandlerI() {
				@Override
