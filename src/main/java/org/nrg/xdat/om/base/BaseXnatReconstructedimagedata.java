/*
 * xnat-data-models: org.nrg.xdat.om.base.BaseXnatReconstructedimagedata
...
public class BaseXnatReconstructedimagedata extends AutoXnatReconstructedimagedata {
	...
	public void validate(final String expectedPath) throws IllegalArgumentException, InvalidValueException {
		if (StringUtils.isBlank(getId())) {
			throw new IllegalArgumentException("Identifiers can't be empty/blank");
		}
		...
		OmUtils.validateXnatAbstractResources(expectedPath, getIn_file());
	}
}
