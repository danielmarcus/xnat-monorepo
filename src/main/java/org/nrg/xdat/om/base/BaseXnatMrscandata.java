/*
 * xnat-data-models: org.nrg.xdat.om.base.BaseXnatMrscandata
...
public class BaseXnatMrscandata extends AutoXnatMrscandata {
    ...
    private static class ScanTypeHistory{
        private final List<ScanType> types = new ArrayList<>();
