/*
 * xnat-api: org.nrg.xdat.om.base.MoverMaker
...
/**
 * Facade for compile-time resolution. Uses Object parameters where the real types
 * (XnatAbstractresourceI, XnatProjectdata, etc.) live in xnat-data-models.
 */
