...
public class FreeformPreferencesTestsConfiguration extends OrmTestConfiguration {
    private static final Map<String, String> EXTRA_HIBERNATE_PROPERTIES = ImmutableMap.of("hibernate.hbm2ddl.import_files", "/org/nrg/prefs/tests/init-freeform-prefs.sql");
